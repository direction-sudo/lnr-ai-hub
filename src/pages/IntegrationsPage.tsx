        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && setPageFinderOpen(true)}
              className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[rgba(24,119,242,0.08)] border border-[rgba(24,119,242,0.2)] text-sm text-[#1877F2] hover:bg-[rgba(24,119,242,0.12)] transition-all font-medium cursor-pointer"
            >
              <span>🔍 Trouver automatiquement mon Page ID Facebook</span>
            </div>
          </div>
        </div>
      </div>
